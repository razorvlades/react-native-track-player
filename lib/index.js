...
function addByIndex(tracks, insertBeforeIndex) {
    ...
    return TrackPlayer.addByIndex(tracks, insertBeforeIndex);
}
...
function removeByIndex(tracks) {
    if(!Array.isArray(tracks)) {
        tracks = [tracks];
    }

    return TrackPlayer.removeByIndex(tracks);
}
...
module.exports.addByIndex = addByIndex;
module.exports.remove = remove;
module.exports.removeByIndex = removeByIndex;
module.exports.skip = TrackPlayer.skip;
module.exports.skipToIndex = TrackPlayer.skipToIndex;
module.exports.move = TrackPlayer.move;
...
module.exports.getTrackByIndex = TrackPlayer.getTrackByIndex;
module.exports.getCurrentTrack = TrackPlayer.getCurrentTrack;
module.exports.getCurrentTrackIndex = TrackPlayer.getCurrentTrackIndex;
